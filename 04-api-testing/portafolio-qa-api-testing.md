...
**Proyecto:** Colección de pruebas de API (positivas y negativas) sobre reqres.in, una API pública de práctica
**Herramienta:** Postman
**Entregable adjunto:** `coleccion-api-testing.postman_collection.json` (colección exportada, importable en Postman)
...
**Valor para QA:** confirma que la API tiene manejo de errores adecuado para campos obligatorios faltantes, devolviendo tanto el código de error correcto como un mensaje descriptivo — buena práctica de diseño de API que facilita el debugging.
